...
import { FiEdit2, FiTrash2, FiSearch, FiPlus, FiPhone, FiMail, FiMapPin } from 'react-icons/fi';
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Manage all suppliers and vendors</p>
          </div>
          <button
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {new Set(vendors.map(v => v.serviceType).filter(Boolean)).size}
                </p>
              </div>
